...
X = blkdiag(...
	hss_sparse_dac_sylv(A.hssl, B.hssl, C.hssl, sA(1:A.ml, 1:A.nl), sB(1:A.ml, 1:A.nl)), ...
	hss_sparse_dac_sylv(A.hssr, B.hssr, C.hssr, sA(A.ml+1:end, A.nl+1:end), sB(A.ml+1:end, A.nl+1:end)) ...
);
