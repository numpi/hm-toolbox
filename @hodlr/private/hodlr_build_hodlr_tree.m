...
if max(m, n) > block_size && min(m, n) > 1
    ...
    H.A11 = build_hodlr_tree_rec(m1, n1, block_size);
    H.A22 = build_hodlr_tree_rec(m2, n2, block_size);
...
function H = build_hodlr_tree_partition_rec(m, n, partitionm, partitionn)
...
if lp > 1
    ...
    if m1 == 0 || m2 == 0 || n1 == 0 || n2 == 0
        ...
        H.A11 = build_hodlr_tree_partition_rec(m1, n1, partitionm(1:lp/2), partitionn(1:lp/2));
        H.A22 = build_hodlr_tree_partition_rec(m2, n2, partitionm(lp/2+1:end) - m1, partitionn(lp/2+1:end) - n1);
