...
% Overloaded subsref function for HALR matrices
...
switch S(1).type
    case '()'
        ...
        varargout = {purge_tree(halr_sub(H,mind,nind))};
    otherwise
        varargout = {builtin('subsref',H,S)};
end
end

function H = halr_sub(H, mind, nind)
...
if is_leafnode(H)
    ...
    H.A11 = halr_sub(H.A11, mind1, nind1);
    H.A22 = halr_sub(H.A22, mind2, nind2);    
    H.A12 = halr_sub(H.A12, mind1, nind2);
    H.A21 = halr_sub(H.A21, mind2, nind1);
end
