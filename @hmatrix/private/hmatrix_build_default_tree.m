function H = hmatrix_build_default_tree(m, n, block_size) % constructs a default geometrical clustering
H = hmatrix;
H.sz = [m, n];
if max(m, n) > block_size && min(m, n) > 1
    ...
    H.A11 = hmatrix_build_default_tree(m1, n1, block_size);
    H.A22 = hmatrix_build_default_tree(m2, n2, block_size);
